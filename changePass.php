...
Date:		April 2019
Name:		changePass.php
Purpose:	used when the user wants to change their password
-->
...
if(isset($_SESSION['user'])) //checks if the user is logged in
{
    if(isset($_POST['oldPass']) && isset($_POST['newPass']) && isset($_POST['confirmPass']))
    {
		...
		//Selects the last 3 passwords usedby the current user.
...
//Put last 3 passwords into an array in order to chaeck if the new password is one of the previous 3
$sentToList = array();
